...
import projPaths from "@vertigis/sdk-library/config/paths.js";

/**
 * @type {string}
 */
const projUuid = (await import(pathToFileURL(path.join(projPaths.projRoot, "uuid.cjs")).href)).default;
